...
deplacement saisie_deplacement(echiquier,couleur player_color, deplacement);
void deplacements_possibles (echiquier, position , deplacement, couleur player_color, int* pointer);
